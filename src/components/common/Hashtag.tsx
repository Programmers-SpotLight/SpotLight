...
const hashtagSize = {
  ...
  big: 'px-3 py-1 max-w-[80px] text-sm'
}

const hashtagCommonClass = ' text-center text-gray-500 rounded-full border-solid border-2 border-gray-100  mr-2 flex items-center'
