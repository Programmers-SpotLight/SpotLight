...
import { fetchUserSelectionList } from "@/http/selectionSearch.api";
...
const useFetchUserSelectionList = ({userId, userSelectionType, sort, page, limit} : IuseFetchUserSelectionList) : UseQueryResult<IsearchResult> => {
